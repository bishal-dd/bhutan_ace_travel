...
<div class="text-center p-5">
    ...
    <p class="text-justify mt-5">
     ...
     <p class="text-justify mt-5">
        At festival times you may need to book over six months ahead to get flights, especially if you are unable to be flexible and are tied to particular dates.  Also if you have particular preferences for hotels then the sooner you book the better chance we have of securing these for you.  Most hotels in Bhutan have only 15 to 20 rooms or so and they can get booked up over 9 to 12 months ahead of time for the busiest dates in peak season, so the earlier you contact us the more likely it is we can meet your preferences.     </p>

    <h2 class="mt-3">A Simple Guide to Booking your Trip</h2>

    <p class="text-justify">
        <b>-</b> Choose the type of tour you are looking for (cultural, festivals, trekking or a mixture of all three)    </p>
    <p class="text-justify">
        <b>-</b> Select an itinerary from those on our site or contact us to design one specially for you    </p>
    <p class="text-justify">
        <b>-</b> Decide on your dates (bearing in mind the seasons and any festivals you want to include)    </p>
    <p class="text-justify">
        <b>-</b> Once you are happy with the options discussed, confirm to us your choice of dates, itinerary and flight/overland routes    </p>
    <p class="text-justify">
        <b>-</b> We will reserve seats for you with Druk Air or Tashi Air
    </p>
    <p class="text-justify">
        <b>-</b> We will also book hotel rooms, transport, guides and everything else necessary for your trip    </p>
    <p class="text-justify">
        <b>-</b> You will need to book your own long-haul flights to your point of departure for Bhutan – make sure you leave plenty of connecting time and preferably an overnight if you can    </p>

    <p class="text-justify">
        <b>-</b> In due course we will let you have payment details for you to transfer payment for your trip
    </p>
    <p class="text-justify">
        <b>-</b> Fill in our visa form, and send to us with a colour scan of your passport
    </p>   
     <p class="text-justify">
        <b>-</b> Once your money has arrived we will send you formal trip confirmation and receipt
    </p>    
    <p class="text-justify">
        <b>-</b> Then we can apply for your visa and issue your flight tickets
        </p>    
        <p class="text-justify">
            <b>-</b> We will send you your tickets by email and a copy of your visa authorisation
            </p>   
             <p class="text-justify">
                <b>-</b> You need to take both these documents with you to show to the airline at check-in
                </p>
                    <p class="text-justify">
                        <b>-</b> Your visa will be stamped into your passport on arrival in Paro
                        </p>   
                         <p class="text-justify">
                            <b>-</b> Don’t forget to find out about visa requirements for any countries you are passing through en route
                            </p>   
                             <p class="text-justify">
                                <b>-</b> Before you go we’ll send you some general information about visiting Bhutan with helpful tips on matters such as money, communications, culture and customs and so on We will also confirm to you the name of your guide (who will meet you at the airport at Paro) and give you his contact details
                                </p>    
                                <p class="text-justify">
                                    <b>-</b> All you have to do then is pack your bags and we’ll see you in Bhutan!
                                </p>

    <h2 class="mt-3">Flights</h2>
    ...
    <p class="text-justify">
        You can have a look at the schedules on the Druk Air website and the Tashi Air website to help you plan your trip.    <p class="text-justify">
    </p>
    <p class="text-justify">
    ...
    <h2 class="mt-3">Travelling Overland</h2>
    ...
    <p class="text-justify ">
        Whether you make payment by bank transfer or via the online payment gateway, your funds will be held in the government account and will not be released to Ora Tours and Travel  until after your tour has taken place. This provides you with the security of knowing that your money is safe until your holiday takes place. If for any reason the trip doesn’t go ahead then the government will not give your money to Blue Poppy but will return it to you (subject to any cancellation charges which apply if you have cancelled the trip). So in the unlikely event that we do not run your trip for you, you would not be out of pocket.
        Please note that if you decide to book with Ora Tours and Travel  you will be booking with us as a local Bhutanese tour operator, licensed and registered in Bhutan, subject to regulation by the Department of Tourism and a member of ABTO (the Association of Bhutanese Tour Operators). Any disputes regarding your booking are to be resolved by arbitration under the laws of Bhutan. 
    </p> 
    <h2 class="mt-3">Cancellation terms (tours)</h2>
    <p class="text-justify ">
        Once booked, Ora Tours and Travel  tours that are cancelled are subject to the following cancellation charges:
    </p> 
    <p class="text-justify">
        <b>-</b> Earlier than 30 days before the start of the tour programme: 10% of the rates
    </p>
    <p class="text-justify"> 
        <b>-</b> Between 30 and 21 days before the start: 20% of the rates
    </p>
    <p class="text-justify">
        <b>-</b> Between 21 and 14 days before the start: 25% of the rates
     </p>
    <p class="text-justify">
        <b>-</b>Between 14 and 7 days before the start: 40% of the rates
    </p>
    <p class="text-justify"> 
        <b>-</b> Less than 7 days before the start or cancellation without notice: 60% of the rates
    </p>
    <p class="text-justify"> 
        <b>-</b> After arrival in Bhutan: 100% of the rates.    
    </p>
    ...
    <p class="text-justify">
        Please note also that when your currency arrives in Bhutan it is booked to Ora Tours and Travel  in local currency at the then prevailing rate of exchange. When we come to return funds to you the cost of the refund will be booked to us again at the then prevailing rate of exchange. If there has been significant fluctuation in exchange rates between the date when funds were received in Bhutan and the date the payment is refunded we reserve the right to return no more than the current US$ equivalent of the amount originally received by us in local currency, to avoid incurring a loss as a result of currency fluctuation when returning your funds for the cancelled trip.
        </p>
    <p class="text-justify">
